...
<footer class="container pt-5">
    <div class="row g-3">
        <div class="col-6 col-md-2 mb-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="tel:<?= Config::get('telephone') ?? ""; ?>" class="nav-link p-0 text-muted">Telephone <i class="bi bi-phone"></i></a></li>
            </ul>
        </div>
        ...
        <div class="col-6 col-md-2 mb-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item mb-2"><a href="<?= Config::get("domain") ?>advertisement" class="nav-link p-0 text-muted">Advertisement</a></li>
    ...
    <div class="d-flex flex-column flex-sm-row justify-content-between align-items-center py-4 my-2 border-top">
        <p>&copy;
            <?= date('Y'); ?>
            <?= htmlspecialchars_decode($settings['title'] ?? Config::get('title')); ?>, Inc. All rights reserved.
        </p>
